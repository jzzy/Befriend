...
public class Vcom_3DES {
	public String keyStr;// 加密/解密密钥，长度为16byte或者24byte。

	public int isEncrypt = -1;// 1为加密，0为解密

	public String message; // 要加密/解密信息（解密时需为十六进制显示的字符串）
	...
	public static void main(String[] args) {
		...
		String outStr="2009000202020";
		System.out.println("加密前:"+outStr);
		// 加密
