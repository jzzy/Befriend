...
<form action="upFone" method="post" enctype="multipart/form-data">
<table>
<tr>
<%
//判断楼主头像
...
<td ><input type="text" name="id" value="<%=f.getId()%>"></td>
</tr>
<tr>
...
<tr>
<td>回帖数:<input type="text" name="total" value="<%=f.getTotal()%>"></td>

</tr>
<tr>
<td>被收藏次数:<input type="text" name="currentPage" value="<%=f.getFollectnum()%>"></td>

</tr>
<tr>
<td>被点击次数:<input type="text" name="pageSize" value="<%=f.getfHits()%>"></td>
...
%>
<td><input style="width: 200px;height: 50px;" type="submit" value="确定修改" ></td>
