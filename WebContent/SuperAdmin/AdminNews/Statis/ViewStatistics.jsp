...
List<Stas> bbt=(List)request.getAttribute("bbt");
...
<tr>
<td width="100px"><%=bbt.get(i).getTime() %></td>
<td width="100px">不统计</td>
<td width="100px"><%=bbt.get(i).getUsersaved() %></td>
<td width="100px"><%=bbt.get(i).getUserlogined() %></td>
<td width="100px"><%=bbt.get(i).getUsersyned() %></td>
<td width="100px">不统计</td>
<td width="100px"><%=bbt.get(i).getOs()%></td>
<td width="100px">全部bbt</td>
</tr>
<%
}
}
