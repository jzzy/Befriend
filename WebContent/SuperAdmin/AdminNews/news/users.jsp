...
<td width="120"><h4><%=androidsta.getPv()+iossta.getPv()+websta.getPv()+wechatsta.getPv()+synsta.getPv()+bbtsta.getPv()%></h4></td>
<td width="120"><h4><%=androidsta.getUv()+iossta.getUv()+websta.getUv()+wechatsta.getUv()+synsta.getUv()+bbtsta.getUv()%></h4></td>
<td width="120"><h4><%=androidsta.getIp()+iossta.getIp()+websta.getIp()+wechatsta.getIp()+synsta.getIp()+bbtsta.getIp()%></h4></td>
</tr>
