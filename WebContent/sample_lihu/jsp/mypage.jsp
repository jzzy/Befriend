	...
	<div id="wrap">
		<div id="header">
			<div class="topArea clearfix">
				...
				<div class="topTool">
					<span class="mapLink"><a href="<%=request.getContextPath() %>/sample_lihu/sitemap.html"><img src="<%=request.getContextPath() %>/sample_lihu/images/toptoolBtn.gif" alt="菜单" /></a></span>
				</div>
			</div>
		...
		<div id="container">
			<div class="myPage">
				...
				<div class="infoArea">
					<h2>资讯相关</h2>
					<ul class="clearfix">
						<li class="leftArea"><a href="myfavor_info.html"><img src="<%=request.getContextPath() %>/sample_lihu/images/ico26.png" alt="我的收藏" /><br/>我的收藏</a></li>
