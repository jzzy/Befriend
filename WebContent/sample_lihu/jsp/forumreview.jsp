			...
			<div class="forumReview">
				<div class="theme">
					<div class="user clearfix">
						<div class="leftArea"><img  " src="<%=request.getContextPath()+u.getImg() %>" alt="sample" /></div>
						<div class="rightArea">
						...
						%>
							...
							<li class="list">
								...
								%>	
									...
									<li class="reply">
										<div class="inner clearfix">
											<div class="leftArea"><img  " src="<%=request.getContextPath()+lfu.get(i1).getImg() %>" alt="sampleuser" /></div>
											<div class="rightArea">
