	...
	<div id="wrap">
		<div id="header">
			<div class="topArea clearfix">
				<h1><a href="<%=request.getContextPath() %>/sample_lihu/index.html"><img src="<%=request.getContextPath() %>/sample_lihu/images/logo.gif" alt="家长之友" /></a></h1>
				<div class="relocation">
					<a href="<%=request.getContextPath() %>/sample_lihu/relocation.html">北京&nbsp;<img src="<%=request.getContextPath() %>/sample_lihu/images/location_more.gif" alt="down" /></a>
				</div>
				<div class="topTool">
		...
		<div id="container">
			...
			<div class="servNav">
				...
				<ul class="clearfix">
					...
					<li><a href="<%=request.getContextPath() %>/sample_lihu/post2.html"><img src="<%=request.getContextPath() %>/sample_lihu/images/servnav5.gif" alt="家长来稿" /></a></li>
					<li><a href="<%=request.getContextPath() %>/sample_lihu/post3.html"><img src="<%=request.getContextPath() %>/sample_lihu/images/servnav6.gif" alt="意见反馈" /></a></li>
				</ul>
			</div>
			<div class="myNav">
