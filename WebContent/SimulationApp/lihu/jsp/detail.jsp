...
<div class="cont">
	...
	<div id="container">
		<div class="detail">
			<div class="clearfix">
				<div class="imgArea">
					<img src="<%=request.getContextPath() %>/SimulationApp/lihu/images/xw_18.png" alt="" />
				</div>
				<div class="infoArea">
					<p class="name">我能创未来</p>
			...
			<p class="adress"><a class="clearfix" href="#">望京西园一区134号楼(炫彩嘉轩)商业2楼207室<img src="<%=request.getContextPath() %>/SimulationApp/lihu/images/grayarrow.gif" alt="" /></a></p>
			...
			<ul>
				<li>
					<div class="inner clearfix">
						...
						<div class="message">
							<p class="userId">HH2006<span class="rate">
							...
							<p class="words">挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！</p>
							<p class="attachImg">
							<img src="<%=request.getContextPath() %>/SimulationApp/lihu/images/b10.png" alt="" />
							<img src="<%=request.getContextPath() %>/SimulationApp/lihu/images/b10.png" alt="" />
							<img src="<%=request.getContextPath() %>/SimulationApp/lihu/images/b10.png" alt="" />
							</p>
							<p class="time">2015/11/19 16:22</p>
						</div>
					</div>
				</li>
				<li>
					<div class="inner clearfix">
						<div class="userImg"><img src="<%=request.getContextPath() %>/SimulationApp/lihu/images/b10.png" alt="ico" /></div>
						<div class="message">
							<p class="userId">HH2006<span class="rate"><img src="<%=request.getContextPath() %>/SimulationApp/lihu/images/detail_star_on.png" alt="" /><img src="<%=request.getContextPath() %>/SimulationApp/lihu/images/detail_star_on.png" alt="" /><img src="<%=request.getContextPath() %>/SimulationApp/lihu/images/detail_star_on.png" alt="" /><img src="<%=request.getContextPath() %>/SimulationApp/lihu/images/detail_star_on.png" alt="" /><img src="<%=request.getContextPath() %>/SimulationApp/lihu/images/detail_star_off.png" alt="" /></span></p>
							<p class="words">挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！挺好的,感觉不错,下次再来！</p>
							<p class="attachImg"></p>
							<p class="time">2015/11/19 16:22</p>
						</div>
		...
		<div class="shopInfo">
			...
			<p class="tel">联系电话&nbsp;:&nbsp;010-69644588</p>
			<p class="shopName">商户名称&nbsp;:&nbsp;琴海畅想文化艺术中心</p>
		</div>
		<div class="nearby">
			<h2>在这家店附近找</h2>
			<ul class="clearfix">
